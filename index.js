...
(function (root, client) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.YouTrack = client(root.popsicle)
  }
  ...
  function handleRequest (client, path, method, body, options) {
    ...
    return client.request(reqOpts).use(xml())
  }
  ...
  function Resource0 (uri, client) {
    ...
    this.admin = new Resource1(uri + '/admin', client)
  }
  ...
  function Resource1 (uri, client) {
    ...
    this.projects = new Resource2(uri + '/projects', client)
  }
  ...
  function Client (options) {
    this.options = extend({
      baseUri: 'http://hbk.myjetbrains.com/youtrack/rest',
      baseUriParameters: {}
    }, options)
